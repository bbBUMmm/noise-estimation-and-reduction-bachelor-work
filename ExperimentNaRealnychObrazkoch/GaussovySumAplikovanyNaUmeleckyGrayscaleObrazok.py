...
image = cv2.imread('UmeleckeObrazky/SedyUmeleckyObraz30x30.png', cv2.IMREAD_GRAYSCALE)
...
for index in range(0, 100):
    filename = f'ZasumenyUmeleckyObrazokPozityVHistograme_{index}.png'
...
plt.savefig(os.path.join(output_dir, "HistogramZasumenehoUmeleckehoObrazku.png"), dpi=300)
