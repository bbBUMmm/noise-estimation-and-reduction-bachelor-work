...
# Načítanie obrázka
noisy_image = cv2.imread('ZasumenyRealnyObrazokPozityVHistograme_0.png', cv2.IMREAD_GRAYSCALE)
...
plt.savefig(os.path.join(output_dir, "VyhladenieAStatistikaRealnyGrayscaleObrazok.png"))
